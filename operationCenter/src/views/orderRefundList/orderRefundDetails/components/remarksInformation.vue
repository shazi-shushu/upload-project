        ...
        <div class="remarkContent">
            <div class="remarkContentItem">
                ...
                <div class="remarkContentItemR">
                    <textarea style="resize:none;" name="maiJia" id="maiJia" cols="30" rows="10" placeholder="卖家为买家留言只能回复一次"></textarea>
                    <div class="maiJiaMsg">保存</div>
                </div>
            </div>
            <div class="remarkContentItem">
                <div class="remarkContentItemL">
                ...
                <div class="remarkContentItemR">
                    <textarea style="resize:none;" name="maiJia" id="maiJia" cols="30" rows="10" placeholder=""></textarea>
                    <div class="remarkMsg">保存</div>
                </div>
            </div>
        </div> -->
    <div v-if="replyMesg.length" style="background-color: #ffffff;">
...
<script>
import { getHotelReplyMessage } from '@/api/orderList/hotel'
