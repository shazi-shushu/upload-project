          ...
          <div class="serverItem_content">
            ...
            <div>
              <el-checkbox-group v-model="item.checkedCities">
                <el-checkbox v-for="city in item.cities" :key="city" class="serverItem_content_item" :label="city" @change="handleCheckedCitiesChange(item.checkedCities,item.id)">{{ city }}</el-checkbox>
              </el-checkbox-group>
            </div>
          </div>
        </div>
