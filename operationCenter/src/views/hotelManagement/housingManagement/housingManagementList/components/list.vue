      ...
      <table>
        ...
        <tbody>
          <tr v-for="(item,index) in list" :key="index">
            ...
            <td>有窗j</td>
            <td class="caoZuoBtn">
              <span><router-link :to="{path:'/hotelManagement/housinglManagementDetails',query:{'hotelName':'11111111111','hotelId':'222222'}}">编辑</router-link></span>
              <span><router-link :to="{path:'/hotelManagementList',query:{'hotelId':'11111111111','roomTypeId':item.roomTypeId}}">酒店管理</router-link></span>
              <span><router-link :to="{path:'/supplyServicesList',query:{'hotelName':'11111111111','hotelId':'222222'}}">供应服务</router-link></span>
              <span>上架</span>
            </td>
          </tr>
        </tbody>
