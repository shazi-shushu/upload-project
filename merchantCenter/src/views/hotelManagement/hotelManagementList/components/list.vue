          ...
          <tr v-for="(item,index) in list" :key="index" style="border-bottom: 4px solid #fbfbfb;">
            ...
            <td>
              ...
              <div class="list_content_l">
                <div class="fl list_content_l_img">
                  <img :src="item.hotelMainPictureUrl" alt="">
                ...
                <div class="fl list_content_l_msg">
                  <div class="color333 fz16">
                    ...
                    <span v-for="(item,index) in hotelStarFilters(item.hotelStar)" :key="index">
                  ...
                  <div class="address">
                    ...
                    <span class="red" style="padding:0px 20px;"><svg-icon icon-class="address" /><router-link :to="{path:'/hotelManagement/hotelManagementDetails',query:{'activeIndex':'4','hotelId':item.hotelId}}">查看地图</router-link></span>
                  </div>
                  <div class="color666 fz14">
                    <span>{{ item.parentHotelGroupName }}</span>
                    <span style="padding:0px 20px;">{{ item.plateName }}</span>
                  </div>
                </div>
              </div>
            </td>
            <td>
              ...
              <div>
                ...
                <span class="red caoZuoBtn fz14"><router-link :to="{path:'/hotelManagement/hotelManagementDetails',query:{'hotelId':item.hotelId}}">查看酒店</router-link></span>
